...
export class CardComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.productService.getProducts().subscribe(producto=>{this.productos =producto;});

    this.subcategoriaService.getSubCategory().subscribe(data=>{this.subcategorias=data;})
  }
